...
export const experience: Job[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Cloud infrastructure: Architected and operated secure AWS infrastructure — containerised compute on ECS, ECR, Fargate, EC2 and Lambda, with hosting and identity via Amplify and Cognito.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Deployment & QA: Shipped to Ubuntu EC2 behind NGINX with tmux process management, CI/CD, Docker Compose, unit and integration tests, Swagger/ReDoc docs, SSL/TLS and automated MySQL backups.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Infrastructure & security: Deployed the stack on Ubuntu EC2 with NGINX, tmux and Docker Compose; managed containers and Postgres via Supabase; enforced OAuth, JWT, CORS and SSL/TLS.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Architecture & DevOps: Authored design and analysis documentation for stakeholders, contributed to project planning, and automated NGINX-based deployments.",
    ],
